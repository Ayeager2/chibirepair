      ...
      >
        ...
        <div className="offcanvas-body">
          <div className="list-group">
            ...
            <Link
              className={`list-group-item list-group-item-action ${location.pathname === "/vendors" ? "active" : ""}`}
              to="/vendors"
            >
              Vendors
            </Link>
            ...
            <Link
              className={`list-group-item list-group-item-action ${location.pathname === "/purchases" ? "active" : ""}`}
              to="/purchases"
            >
              Purchase Entry
            </Link>
            ...
            <Link
              className={`list-group-item list-group-item-action ${location.pathname === "/purchase-history" ? "active" : ""}`}
              to="/purchase-history"
            >
              Purchase History
            </Link>
            <Link
              className={`list-group-item list-group-item-action ${location.pathname === "/invoices" ? "active" : ""}`}
              to="/invoices"
            >
              Invoices
            </Link>
            <Link
              className={`list-group-item list-group-item-action ${location.pathname === "/invoice-history" ? "active" : ""}`}
              to="/invoice-history"
            >
              Invoice History
            </Link>
